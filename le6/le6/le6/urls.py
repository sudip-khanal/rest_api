"""
URL configuration for le6 project.
...
urlpatterns = [
    ...
    path('studentapi/',views.StudentListandCreateapi.as_view(),name='studentapi'),
    ...
    #path('studentapi/<int:pk>',views.StudentList.as_view(),name='studentapi'),
